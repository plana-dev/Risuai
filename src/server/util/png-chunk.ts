...
export const PngChunk = {
    ...
    write: async (data: Uint8Array, chunks: { [key: string]: string }, options: { writer?: { write: (data: Uint8Array) => Promise<void>; close: () => Promise<void> } } = {}): Promise<void | Buffer> => {
        let pos = 8;
        const newData: Uint8Array[] = [];
